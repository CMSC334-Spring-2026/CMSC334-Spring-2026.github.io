...
// Almost always should use public inheritance.  Inheritance access specifiers don't
// change access for subclasses.  But does change things for external code that use
// the subclass.  
...
//NOTE: The only things that can be included in a member intialization
// list are non-static data members and/or a base class constructor
